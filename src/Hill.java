    ...
    public static void main(String args[]) throws IOException
    {
        ...
        else
        {
            ...
            if (obj.check(key, s))
            {
                ...
                System.out.println(obj.divide(line, s));
                System.out.println(obj.cofact(obj.keymatrix, s));
            }
        }
    }

	public static String cofact(String line, String key) {
		// TODO Auto-generated method stub
		return null;
	}

	public static String divide(String cofact, String key) {
		// TODO Auto-generated method stub
		return null;
	}
}